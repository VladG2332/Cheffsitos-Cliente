...
const NuevoPlatillo = () => {
    ...
    // Context con las oepraciones de firebase
                ...
                <div className='w-full max-w-3xl'>
                    ...
                    >
                        ...
                        <div className='mb-4'>
                            ...
                            <textarea
                                className=' shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight  focus:outline-blue-300 h-40'
                                id='descripcion'
